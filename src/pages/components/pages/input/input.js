      ...
      <ScrollView className="components-page">
        ...
        <View className="components-page__body">
          <View className="components-page__body-example example">
            <Text className="example-header">可以自动聚焦的input</Text>
            <View className="example-body">
              <Input type="text" placeholder="将会获取焦点" focus />
            </View>
          </View>
          <View className="components-page__body-example example">
            <Text className="example-header">控制最大输入长度的input</Text>
            <View className="example-body">
              <Input
                type="text"
          ...
          <View className="components-page__body-example example">
            <Text className="example-header">数字输入的input</Text>
            <View className="example-body">
              <Input type="number" placeholder="这是一个数字输入框" />
            </View>
          </View>
          <View className="components-page__body-example example">
            <Text className="example-header">密码输入的input</Text>
            <View className="example-body">
              <Input
                type="password"
                password
          ...
          <View className="components-page__body-example example">
            <Text className="example-header">身份证输入的input</Text>
            <View className="example-body">
              <Input type="idcard" placeholder="身份证输入键盘" />
            </View>
          </View>
          <View className="components-page__body-example example">
            <Text className="example-header">控制占位符颜色的input</Text>
            <View className="example-body">
              <Input
                type="text"
