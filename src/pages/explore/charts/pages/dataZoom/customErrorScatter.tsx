...
import '../style.scss';
/**
https://echarts.apache.org/examples/zh/editor.html?c=custom-error-scatter&lang=ts
 */
export default function customErrorScatter() {
  ...
  return (
    <View>
      <View className="header">使用自定系列给散点图</View>
      <View className="body">
        <Chart option={option} />
      </View>
    </View>
